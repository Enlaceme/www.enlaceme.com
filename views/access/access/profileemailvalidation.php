...
<body>    
    <section class="parallax-access">
        <center>
            ...
            <h5 class="deep-orange-text">Si el correo electrónico es correcto por favor envia la solicitud de validación.</h5>
            ...
            <div class="container">
                <div class="z-depth-1 grey lighten-4 row hoverable" style="display: inline-block; padding: 25px; border: 1px solid #EEE; width: 370px;">
                    ...
                    <form class="col s12" method="post" id="access-form-emailvalidate">
                        <div class="row">
                            <div class="col s12">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input class="validate" type="email" name="vEmail" id="vEmail" value="<?Php echo $this->vEmail; ?>" readonly/>
                        ...
                        <center>
                            <div class="row">
                                <button type="submit" class="col s12 btn waves-effect deep-orange">Enviar Correo</button>
                            </div>
                        </center>
                    </form>
                </div>
