        ...
        <center>
            ...
            <div class="container">
                <div class="z-depth-1 grey lighten-4 row hoverable" style="display: inline-block; padding: 25px; border: 1px solid #EEE;">
                    ...
                    <form class="col s12" method="post" id="access-form-login">
                        <div class="row">
                            <div class="col s12">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input class="validate" type="password" name="vPassword" placeholder="Contraseña" />
            ...
            <a class="btn btn-small deep-orange" href="<?php echo BASE_VIEW_URL; ?>access/register">Registrar</a>
            <a class="btn btn-small green" href="<?php echo BASE_VIEW_URL; ?>access/sendEmailValidation">Validar Cuenta</a>
        </center>
