...
<html lang="es">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="#">
                <img src="<?Php echo $vParamsViewBackEndLayout['root_backend_pages_images']; ?>logo-light.svg" alt="" width="320px"/>
            </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="#" method="post">
                <h3 class="form-title font-color">Ingresa a tu cuenta</h3>
                <div class="alert alert-danger display-hide">
                    <button class="close" data-close="alert"></button>
                    <span> Ingresa tu correo y la contraseña. </span>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <button id="facebookLoginAccess" type="button" class="btn blue-steel pull-right">Ingresar con Facebook</button>
                </div>
                <div class="forget-password">
                    <h4 class="font-color">¿Olvidaste tu contraseña?</h4>
                    <p class="font-color"> No te preocupes, ingresa <a href="javascript:;" id="forget-password" class="font-color">Aquí</a> para recuperarla. </p>
                </div>
                <div class="create-account">
                    <p class="font-color">¿No tienes una cuenta aun?&nbsp;<a href="javascript:;" id="register-btn" class="font-color"> Registrate gratis aquí</a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
            ...
            <form class="forget-form" action="#" method="post">
                <h3 class="form-title font-color">¿Olvidaste tu contraseña?</h3>
                <p class="font-color">Ingresa tu correo electrónico para cambiar la contraseña.</p>
                <div class="form-group">
                    <div class="input-icon">
                ...
                <div class="form-actions">
                    <button type="button" id="back-btn" class="btn red">Volver</button>
            ...
            <form class="register-form" action="#" method="post">
                <h3 class="form-title font-color">Registrarme</h3>
                <p class="font-color">Ingresa todos los datos solicitados</p>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Nombres</label>
                    <div class="input-icon">
                        <i class="fa fa-font"></i>
                        <input class="form-control placeholder-no-fix" type="text" placeholder="Nombres" name="vName" id="vName" />
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        <i class="fa fa-font"></i>
                        <input class="form-control placeholder-no-fix" type="text" placeholder="Apellidos" name="vLastNames" id="vLastNames" />
                    </div>
                </div>
                <div class="form-group">
                    <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
                    ...
                    <div class="input-icon">
                        <i class="fa fa-envelope"></i>
                        <input class="form-control placeholder-no-fix" type="text" placeholder="Correo electrónico" name="vEmail" id="vEmail" /> </div>
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">País</label>
                    <select name="vCountry" id="country_list" class="select2 form-control">
                        <option value=""></option>
                ...
                <p class="font-color"> Datos de acceso: </p>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Contraseña</label>
                    <div class="input-icon">
                        <i class="fa fa-lock"></i>
                        <input class="form-control placeholder-no-fix" type="password" autocomplete="off" id="vPassword" placeholder="Contraseña" name="vPassword" /> </div>
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Repite la Contraseña </label>
                    <div class="controls">
                        <div class="input-icon">
                            <i class="fa fa-check"></i>
                            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="repetir contraseña" name="vRePassword" /> </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="mt-checkbox mt-checkbox-outline font-color">
                        <input type="checkbox" name="tnc" /> Estoy de acuerdo con los
                        <a href="javascript:;">Términos de Uso </a> &
                ...
                <div class="form-actions">
                    <button id="register-back-btn" type="button" class="btn red"> Volver </button>
                    <button type="submit" id="register-submit-btn" class="btn green pull-right"> Registrarme </button>
                </div>
            </form>
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2018 &copy; Enlaceme.com la red global de trabajo. </div>
        <!-- END COPYRIGHT -->
        <!-- [if lt IE 9]>
