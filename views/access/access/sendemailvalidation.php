...
<body>    
    <section class="parallax-access">
        <center>
            ...
            <a class="btn btn-small deep-orange" href="<?php echo BASE_VIEW_URL; ?>access">Ingresar</a>
            <a class="btn btn-small red" href="<?php echo BASE_VIEW_URL; ?>access/register">Registrar</a>
        </center>
