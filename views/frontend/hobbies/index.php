...
<body>
  ...
  <div id="index-banner" class="parallax-container">
      ...
      <div class="container">
        <div class="center">
            <a class="topbar-logo" href="#!">
                <img class="logo-text-55 padding-top-30" src="<?Php echo $vParamsViewBackEndLayout['root_backend_layouts_images']; ?>logo-pasatiempo-text.svg" align="center">
            </a>
        </div>
    ...
    <div class="parallax"><img src="<?Php echo $vParamsViewFrontEndLayout['root_frontend_img']; ?>hobbies_bg.jpg" alt=""></div>
  </div>
          ...
          <div class="row">
            <div class="col s12">
              <h3><i class="mdi-content-send"></i></h3>
                ...
                <h4 class="title-h4">Personas con pasatiempos</h4>
