            ...
            <div class="col s12 m9 l9">
                ...
                <div class="row">
                    <div class="col s12 m8 l8">
                        ...
                        <div class="card">
                            <ul class="collection">
                                <li class="collection-item grey lighten-4"><strong class="deep-orange-text">Correo electrónico: </strong><?Php echo $this->vUserEmail; ?></li>
                                <li class="collection-item grey lighten-4"><strong class="deep-orange-text">Fecha Nacimiento: </strong><?Php echo $this->vUserDateBirth; ?></li>
